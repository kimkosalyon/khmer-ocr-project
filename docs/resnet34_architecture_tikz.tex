...
% Explicitly define layers to fix the hidden background box rendering bugs
...
\begin{tikzpicture}[
    thick,
    % Widened the horizontal node distance to give everything breathing room
    ...
    % Modified ResNet Layers (OCR Specific)
    ...
    % Outer Titles (FIXED: Changed \bftab to \bfseries)
